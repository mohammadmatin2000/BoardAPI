...
from backgammon.src.colour import Colour
from backgammon.src.game import Game
from backgammon.src.strategy_factory import StrategyFactory
from backgammon.src.strategies import HumanStrategy
