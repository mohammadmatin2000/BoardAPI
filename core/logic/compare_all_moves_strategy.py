...
class CompareAllMoves(Strategy):
    ...
    def move_recursively(self, board, colour, dice_rolls):
        ...
        valid_pieces = [board.get_piece_at(piece_location) for piece_location in pieces_to_try]
        valid_pieces.sort(key=Piece.spaces_to_home, reverse=True)  # مرتب‌سازی بر اساس فاصله
